        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gap: '20px', marginTop: '30px' }}>
            <div style={{
              ...
              <h3 style={{ color: '#BD94BB', marginBottom: '15px', fontSize: '1.1em' }}>
                🔧 Diagram Sources (D2)
              </h3>
              <div style={{ display: 'flex', gap: '15px', flexWrap: 'wrap' }}>
                <a
                  href="/diagrams-source/01-platform-overview.d2"
                  download
                  style={{
                  ...
                  onMouseOver={(e) => {
                    e.currentTarget.style.background = 'rgba(224, 53, 162, 0.25)';
                  }}
                  onMouseOut={(e) => {
                    e.currentTarget.style.background = 'rgba(224, 53, 162, 0.15)';
                  }}
                >
                  📄 01-platform-overview.d2
                </a>
                <a
                  href="/diagrams-source/02-user-journey.d2"
                  download
                  style={{
                    background: 'rgba(224, 53, 162, 0.15)',
                    color: '#E035A2',
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', gap: '15px', flexWrap: 'wrap' }}>
                <a
                  href="/diagrams/01-platform-overview.png"
                  download
                  style={{
                    background: 'rgba(189, 148, 187, 0.15)',
                    color: '#BD94BB',
                    padding: '8px 16px',
                    borderRadius: '8px',
                    textDecoration: 'none',
                    border: '1px solid rgba(189, 148, 187, 0.3)',
                    fontSize: '0.9em',
                    transition: 'all 0.3s ease'
                  }}
                  onMouseOver={(e) => {
                    e.currentTarget.style.background = 'rgba(189, 148, 187, 0.25)';
                  }}
                  onMouseOut={(e) => {
                    e.currentTarget.style.background = 'rgba(189, 148, 187, 0.15)';
                  }}
                >
                  🖼️ 01-platform-overview.png (301 KB)
                </a>
                <a
                  href="/diagrams/02-user-journey.png"
                  download
                  style={{
                    background: 'rgba(189, 148, 187, 0.15)',
                    color: '#BD94BB',
